...
class DestaquesConvidado extends StatefulWidget {
  const DestaquesConvidado({super.key, required this.title});

  final String title;

  @override
  State<DestaquesConvidado> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<DestaquesConvidado> {
  @override
