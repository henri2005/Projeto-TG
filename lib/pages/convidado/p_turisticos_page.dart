...
import 'package:turisr/pages/convidado/ponto_turistico_screen.dart';

class PontosTuristicosConvidado extends StatefulWidget {
  const PontosTuristicosConvidado({super.key, required this.title});

  final String title;

  @override
  State<PontosTuristicosConvidado> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<PontosTuristicosConvidado> {
