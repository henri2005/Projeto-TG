...
class _MyHomePageState extends State<EstabelecimentoScreen> {
  ...
  void initState() {
    super.initState();
    key = 'favorite_${widget.estabelecimento.idEstabelecimento}';
  ...
  void favoritar() async {
    try {
      ...
      final response = await dio.post(
        'http://10.0.0.94/api_turismo/locais/favoritar/${widget.estabelecimento.idEstabelecimento}',
        data: dados,
      );
  ...
  void adicionaRoteiro() async {
    try {
      ...
      final response = await dio.post(
        'http://10.0.0.94/api_turismo/locais/roteiro/${widget.estabelecimento.idEstabelecimento}',
        data: dados,
      );
